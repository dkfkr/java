...
public class RegularExpressionTest {
		...
		public static void main(String[] args) {
			...
			String[] patterns = {"[0-9]+",        // 숫자 1개 이상
								 ...
								 "[A-Z]*",       // 영어 대문자 0개
								 "[가-힣]+",      // 한글 1자 이상
								 "^[0-9a-z]*",   // 숫자+영어 소문자 1개 이상
								 "^[0-9rk-힣]*", // 숫자+영어 조합 0개이상
			...
			String[] words = {"apple", "123한글", "123456" , "011" ,"hello", "홍길동", "1", "Banana", "apple", "Apple", "#"};
			
			for(String word : words) {
				
				System.out.println(word + "문자가 일치하는 패턴 : ");
